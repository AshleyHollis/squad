# Squad Ralph-Specum Integration — Implementation Spec
...
- All modifications go on branch `ralph-specum`
...
`docs/ralph-specum/squad-spec-guide.md`
...
docs/ralph-specum/
└── squad-spec-guide.md                ← Full guide (reference only)
```
...
4. Create `docs/ralph-specum/squad-spec-guide.md` — copy the full reference guide
...
in `docs/ralph-specum/squad-spec-guide.md`. Key sections to extract from:
