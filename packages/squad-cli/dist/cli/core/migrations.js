...
const migrations = [
    ...
    },
    {
        ...
        run(squadDir) {
            ...
            const skillNames = fs.readdirSync(legacySkillsDir).filter(entry => fs.existsSync(path.join(legacySkillsDir, entry, 'SKILL.md')));
            ...
            for (const skillName of skillNames) {
                fs.cpSync(path.join(legacySkillsDir, skillName), path.join(copilotSkillsDir, skillName), { recursive: true, force: false, errorOnExist: false });
            }
