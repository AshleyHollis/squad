 ...
 * @module cli
 */
export { type ReleaseChannel, type UpdateInfo as SDKUpdateInfo, type UpgradeOptions as SDKUpgradeOptions, checkForUpdate, performUpgrade } from './upgrade.js';
...
export { type UpgradeOptions, type UpdateInfo, runUpgrade } from './core/upgrade.js';
...
export { getPackageVersion, readInstalledVersion } from './core/version.js';
