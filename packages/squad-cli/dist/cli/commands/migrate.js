 ...
 * Parse routing.md
 */
function parseRoutingMd(squadDir) {
 ...
 */
function parseAgentCharter(squadDir, agentName) {
 ...
 */
function parseCastingPolicy(squadDir) {
 ...
 */
function generateSquadConfig(team, agents, routing, casting) {
    const lines = [];
    lines.push("import {");
 ...
 */
export async function runMigrate(cwd, options) {
