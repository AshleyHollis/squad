 ...
 */
export async function runPersonal(cwd, subcommand, args) {
    switch (subcommand) {
        case 'init':
            await personalInit();
            break;
        ...
        default:
            fatal(`Unknown personal subcommand: ${subcommand}\n` +
...
async function personalList() {
    ...
    for (const agent of agents) {
        ...
        console.log(`  ${agent.name.padEnd(maxNameLen)}  ` +
...
// Subcommand: add
// ============================================================================
async function personalAdd(name, role) {
    const personalDir = resolvePersonalSquadDir();
    if (!personalDir) {
...
// Subcommand: remove
// ============================================================================
async function personalRemove(name) {
    const personalDir = resolvePersonalSquadDir();
    if (!personalDir) {
        fatal('Personal squad not initialized. Run `squad personal init` first.');
    }
