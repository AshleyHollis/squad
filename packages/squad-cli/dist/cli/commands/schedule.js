 ...
 */
export async function runSchedule(cwd, subcommand, args) {
    switch (subcommand) {
        case 'list':
        ...
        case 'status':
            ...
            break;
        default:
            fatal(`Unknown schedule subcommand: ${subcommand}\n` +
...
// Subcommand: list
// ============================================================================
async function scheduleList(cwd) {
...
// Subcommand: run
// ============================================================================
async function scheduleRun(cwd, id) {
    const schedulePath = resolveSchedulePath(cwd);
...
// Subcommand: init
// ============================================================================
async function scheduleInit(cwd) {
    const schedulePath = resolveSchedulePath(cwd);
    const mod = await loadSchedulerModule();
...
// Subcommand: status
// ============================================================================
async function scheduleStatus(cwd) {
    const schedulePath = resolveSchedulePath(cwd);
    const statePath = resolveStatePath(cwd);
    const mod = await loadSchedulerModule();
    let manifest;
