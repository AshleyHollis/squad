 ...
 */
export function saveSession(teamRoot, session) {
 ...
 */
export function listSessions(teamRoot) {
    const dir = sessionsDir(teamRoot);
    if (!existsSync(dir))
        return [];
 ...
 */
export function loadLatestSession(teamRoot) {
 ...
 */
export function loadSessionById(teamRoot, sessionId) {
    const dir = sessionsDir(teamRoot);
    if (!existsSync(dir))
        return null;
