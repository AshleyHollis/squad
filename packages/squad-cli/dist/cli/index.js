 ...
 * @module cli
 */
export { checkForUpdate, performUpgrade } from './upgrade.js';
...
export { runUpgrade } from './core/upgrade.js';
...
export { runCopilot } from './commands/copilot.js';
export { runDoctor, doctorCommand } from './commands/doctor.js';
