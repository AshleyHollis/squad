...
const SQUAD_DIR_NAMES = ['.squad', '.ai-team'];
/**
 ...
 */
export function loadDirConfig(squadDir) {
 ...
 */
export function isConsultMode(config) {
 ...
 */
export function resolveSquadPaths(startDir) {
 ...
 */
export function ensurePersonalSquadDir() {
    const globalDir = resolveGlobalSquadPath();
    const personalDir = path.join(globalDir, 'personal-squad');
 ...
 */
export function ensureSquadPathDual(filePath, projectDir, teamDir) {
    const resolved = path.resolve(filePath);
 ...
 */
export function ensureSquadPathResolved(filePath, paths) {
