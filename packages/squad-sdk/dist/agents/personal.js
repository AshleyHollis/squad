...
function parseCharterMetadataBasic(content) {
 ...
 */
export function mergeSessionCast(projectAgents, personalAgents) {
    ...
    const uniquePersonal = personalAgents.filter(a => !projectNames.has(a.name.toLowerCase()));
