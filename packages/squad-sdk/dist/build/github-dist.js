 ...
 */
export function validateGitHubRelease(config, version) {
    const errors = [];
 ...
 */
export function getInstallCommand(config) {
    const c = resolveConfig(config);
 ...
 */
export function getDefaultDistConfig() {
...
//# sourceMappingURL=github-dist.js.map