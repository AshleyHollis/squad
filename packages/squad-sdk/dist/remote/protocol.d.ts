 ...
 */
export declare const RC_PROTOCOL_VERSION = "1.0";
...
export type RCServerEvent = RCStatusEvent | RCHistoryEvent | RCDeltaEvent | RCCompleteEvent | RCAgentsEvent | RCToolCallEvent | RCPermissionEvent | RCUsageEvent | RCErrorEvent | RCPongEvent;
...
export type RCClientCommand = RCPromptCommand | RCDirectCommand | RCSlashCommand | RCPermissionResponse | RCPingCommand;
...
export declare function serializeEvent(event: RCServerEvent): string;
export declare function parseCommand(data: string): RCClientCommand | null;
